...
let Product = {
  ...
  render: function (products) {
    if (!products) products = this.products;   //ถ้าไม่ได้รับ products เข้ามาให้ใช้ products ของ object
...
//เขียนแบบปกติ
      ...
      // card.className = 'card shadow-lg text-center border-0';
      // card.style = 'width: 18rem;';

      // let img = document.createElement('img');
      // img.src = `./assets/images/${product.pictureName}`;
      // img.style = "height: 200px; ";

      // let price = document.createElement('p');
      // price.className = 'card-title';
      // price.innerText = `ราคา : ${product.price} บาท`;

      // let describe = document.createElement('p');
      // describe.className = 'card-title';
      // describe.innerText = product.describe;